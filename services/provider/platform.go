...
func (s *service) GetProviders(ctx context.Context) ([]*types.Platform, error) {
...
func (s *service) GetProvider(ctx context.Context, id uint) (*types.Platform, error) {
...
func (s *service) UpdateProvider(ctx context.Context, id uint, platform types.Platform) (*types.Platform, error) {
	// 只更新非零值字段
